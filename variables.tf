...
variable "diagnostic_settings_azure_firewall" {
  ...
  default     = {}
  description = <<DESCRIPTION
  A map of diagnostic settings to create on the firewalls. The map key is deliberately arbitrary to avoid issues where map keys maybe unknown at plan time.
